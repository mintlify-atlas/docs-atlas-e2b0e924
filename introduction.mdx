---
title: "LRhub: Interactive Linux Terminal Hub"
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/tools/kbotter"
  >
    A Kahoot game botter that automates joining and answering questions in Kahoot sessions. Runs as a Python script from within the hub.
  </Card>
  <Card
    title="Create File"
    icon="file"
